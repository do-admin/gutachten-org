...
export const metadata: SubpageMetadata = {
  ...
  canonical:
    ...
    "/nutzungsdauergutachten/{{programmaticInstanceSlug}}/",
  openGraph: {
    title:
      "Nutzungsdauergutachten {{programmaticInstanceName}}",
    description:
...
const structuredDataComponents = [
  ...
  createComponent<StructuredDataComponent>({
    ...
    schemaType: "article",
    data: {
      headline: `Nutzungsdauer in {{programmaticInstanceName}} – ${templateVariables.siteName}`,
      description:
        "Informationen zur Nutzungsdauer von Immobilien in {{programmaticInstanceName}} und deren Bedeutung für die Abschreibung und steuerliche Behandlung.",
      url: `${templateVariables.siteUrl}/nutzungsdauer-{{programmaticInstanceSlug}}`,
      image: [
        {
          "@type": "ImageObject",
      ...
      mainEntityOfPage: {
        "@type": "WebPage",
        "@id": `${templateVariables.siteUrl}/nutzungsdauer-{{programmaticInstanceSlug}}`,
      },
      inLanguage: "de-DE",
...
const nutzungsdauerCityContent: SubpageContent = validateContent([
  ...
  createComponent<TextImageComponent>({
    ...
    taxSavingsProps: {
      ...
      title:
        "Steuersparpotenzial nutzen –\nmit verkürzter\nAbschreibungsdauer in {{programmaticInstanceName}}",
      mediaPosition: "right",
      intro:
        "Als Vermieter in {{programmaticInstanceName}} können Sie Ihre Immobilie deutlich schneller abschreiben – und dadurch jedes Jahr bares Geld sparen. Anstelle der pauschalen 50 Jahre Nutzungsdauer erlaubt der Gesetzgeber eine verkürzte AfA, wenn Sie diese durch ein qualifiziertes Restnutzungsdauergutachten belegen.",
      secondIntro:
        "Gerade bei älteren Immobilien – insbesondere mit Baujahr vor 2000 – ist eine reale Restnutzungsdauer von 25 bis 35 Jahren oft plausibel. Das Gutachten dient als offizieller Nachweis gegenüber dem Finanzamt und ermöglicht höhere Abschreibungen und spürbare Steuervorteile.\n\nJetzt kostenlose Ersteinschätzung für Ihre Immobilie in {{programmaticInstanceName}} anfordern!",
      cta: {
        label: "Kostenlose Ersteinschätzung",
        href: "/restnutzungsdauergutachten-ersteinschaetzung/",
        external: true,
      ...
      media: {
        ...
        alt: "Steuersparpotenzial nutzen – mit verkürzter Abschreibungsdauer in {{programmaticInstanceName}}",
        width: 548,
        height: 612,
      },
  ...
  createComponent<TextImageComponent>({
    ...
    taxSavingsProps: {
      sectionId: "nutzungsdauer-city-section-1",
      title:
        "Steuervorteile sichern durch verkürzte Abschreibung in\n{{programmaticInstanceName}}",
      mediaPosition: "left",
      intro:
        "Ein Restnutzungsdauergutachten für Ihre Immobilie in {{programmaticInstanceName}} kann Ihre steuerliche Abschreibung spürbar verkürzen – oft auf 30 oder 15 Jahre. Das senkt Ihre Steuerlast und steigert Ihre jährliche Nachsteuerrendite. Besonders bei vermieteten Bestandsimmobilien ist das ein einfacher Hebel für mehr Netto vom Brutto.",
      secondIntro:
      ...
      media: {
        ...
        alt: "Steuervorteile sichern durch verkürzte Abschreibung in {{programmaticInstanceName}}",
        width: 548,
        height: 612,
      },
      mediaClassName: "max-w-[644px] object-cover max-h-[720px]",
  ...
  createComponent<BaresGeldSparenSectionComponent>({
    ...
    title:
      "Restnutzungsdauergutachten in {{programmaticInstanceName}} -\neinfach, schnell und steuerwirksam: worauf es ankommt",
    bulletItems: [],
    cardLayoutColumns: 2,
    cards: [
      {
