...
const structuredDataComponents = [
  ...
  createComponent<StructuredDataComponent>({
    ...
    schemaType: "article",
    data: {
      headline: `Immobilienbewertung {{programmaticInstanceName}} – ${templateVariables.siteName}`,
      description:
        "Professionelle Immobilienbewertung in {{programmaticInstanceName}} durch zertifizierte Sachverständige. Verkehrswertgutachten nach ImmoWertV.",
      url: `${templateVariables.siteUrl}/immobilienbewertung-{{programmaticInstanceSlug}}`,
      ...
      articleSection: "Immobilienbewertung",
    },
  }),
];
...
const immobilienbewertungCityContent: SubpageContent = validateContent([
  ...
  createComponent<HeroWithFeatureCardsComponent>({
    ...
    subHeading: "Immobilienbewertung in Berlin\nund Umgebung",
    subtitle:
    ...
    ctas: [
      {
        ...
        external: true,
        className:
          "!px-4.5 md:max-w-max! w-full! md:justify-between justify-center! gap-2 md:justify-between md:gap-6",
        icon: "ArrowUpRight",
      },
    ],
    logos: [
  ...
  createComponent<BaresGeldSparenSectionComponent>({
    ...
    cta: {
      ...
      external: true,
      className:
        "md:w-fit w-full! md:max-w-max! justify-center! gap-2 md:justify-between md:gap-6 !px-4.5",
    },
  ...
  createComponent<ClientComponentComponent>({
    ...
    props: {
      src: "https://www.google.com/maps?q=Brunnenstraße+178,+10119+Berlin,+Deutschland&output=embed&hl=de&z=13",
      title: "Standort Karte - Immobilienbewertung Berlin",
      height: 600,
